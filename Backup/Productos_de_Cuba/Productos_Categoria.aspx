<%@ Page Title="Productos por categoría" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Productos_Categoria.aspx.cs" Inherits="Productos_Categoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="title_categoria" style="padding: 43px 0 15px 12px">
        ...
        <span style="padding-left: 5px; font: bold 10pt Verdana">
            <asp:Label ID="LCategoria" runat="server"></asp:Label>    
        </span>
    </div>  
    <div id="link_pequeno">
    ...
    <div id="li_grid_container" style="font-family: Verdana; padding-left: 12px;">
        ...
        <asp:ObjectDataSource ID="ProductosCategoriasObjectDataSource" runat="server" SelectMethod="ObjectDataSourceIDCategoria"
                           TypeName="BLLayer.Producto" DeleteMethod="Delete">   
        <SelectParameters>
             <asp:QueryStringParameter QueryStringField="id" Name="IDCategoria" Type="Int32"/>  
        </SelectParameters>
        <DeleteParameters>
